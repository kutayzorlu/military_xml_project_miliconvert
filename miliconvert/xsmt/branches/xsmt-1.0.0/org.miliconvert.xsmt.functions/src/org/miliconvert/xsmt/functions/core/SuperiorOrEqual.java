...
public class SuperiorOrEqual extends AbstractFunctionImpl {
	 ...
	 */
	private Boolean superiorOrEqual(Integer a, Integer b) {
		return a >= b;
	}
	...
	public Boolean execute(Integer a, Integer b) throws TModelException {
		if (a == null || b == null) {
			throw new TModelException(
					"One parameter of the superior or equal function is null: " + ": a=" //$NON-NLS-1$ //$NON-NLS-2$
							+ a + ", " + "b=" + b); //$NON-NLS-1$ //$NON-NLS-2$
		} else
			return superiorOrEqual(a, b);
	}
}
