...
public class Inferior extends AbstractFunctionImpl {
	 ...
	 * @param a
	 * @param b
	 * @return true if a is inferior to b
	 */
	private Boolean inferior(Integer a, Integer b) {
		return a < b;
	}
	...
	public Boolean execute(Integer a, Integer b) throws TModelException {
		if (a == null || b == null) {
			throw new TModelException(
					"One parameter of the inferior function is null: " + ": a=" //$NON-NLS-1$ //$NON-NLS-2$
