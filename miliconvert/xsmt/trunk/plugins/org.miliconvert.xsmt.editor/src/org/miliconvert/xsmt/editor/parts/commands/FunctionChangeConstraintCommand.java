...
public class FunctionChangeConstraintCommand extends Command {

	private Rectangle constraint;
	private Point prevLocation;
	private FunctionElementEditPart child;

	public FunctionChangeConstraintCommand(FunctionElementEditPart child,
			Rectangle constraint) {
		this.child = child;
		this.constraint = constraint;
		this.prevLocation = getModel().getLocation();
		
		setLabel(Messages.FunctionChangeConstraintCommand_label_move);
	}
