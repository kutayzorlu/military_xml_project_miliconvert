[consequence][]Règle {rule_name}=AtoFieldRules.{rule_name}($s,$f);
...
[consequence][]Si champ {champ}=CommonFieldRules.log("TODO");
[consequence][]CDIFF zone{zone} \= '-'= CommonFieldRules.log("TODO");
[consequence][]On ne traite pas la zone {zone} si la Force possède déjà une Localisation= CommonFieldRules.log("TODO");
