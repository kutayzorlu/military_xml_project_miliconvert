...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Type Priorite Technique</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getPriorite <em>Priorite</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getDebutValidite <em>Debut Validite</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getFinValidite <em>Fin Validite</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getCTE <em>CTE</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getCE <em>CE</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getAppliquePourHoraireManoeuvre <em>Applique Pour Horaire Manoeuvre</em>}</li>
 *   <li>{@link mpia.schema.TypePrioriteTechnique#getConcerneTypeEquipement <em>Concerne Type Equipement</em>}</li>
 * </ul>
 * </p>
 *
 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique()
 * @model annotation="urn:MPIA-schemaInfo entity_Type='INSTANCIABLE_ENTITY'"
 *        extendedMetaData="name='type_PrioriteTechnique' kind='elementOnly'"
 * @generated
 */
public interface TypePrioriteTechnique extends EObject {
	/**
	 ...
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_Priorite()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getPriorite <em>Priorite</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link mpia.schema.TypePrioriteTechnique#getPriorite <em>Priorite</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetPriorite()
	 * @see #getPriorite()
	...
	/**
	 * Returns whether the value of the '{@link mpia.schema.TypePrioriteTechnique#getPriorite <em>Priorite</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_DebutValidite()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getDebutValidite <em>Debut Validite</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_FinValidite()
	 * @model dataType="mpia.meta.TypeDataTypeGDH"
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getFinValidite <em>Fin Validite</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCTE(String)
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_CTE()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getCTE <em>CTE</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCE(String)
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_CE()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getCE <em>CE</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_AppliquePourHoraireManoeuvre()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getAppliquePourHoraireManoeuvre <em>Applique Pour Horaire Manoeuvre</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mpia.schema.SchemaPackage#getTypePrioriteTechnique_ConcerneTypeEquipement()
	...
	/**
	 * Sets the value of the '{@link mpia.schema.TypePrioriteTechnique#getConcerneTypeEquipement <em>Concerne Type Equipement</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
