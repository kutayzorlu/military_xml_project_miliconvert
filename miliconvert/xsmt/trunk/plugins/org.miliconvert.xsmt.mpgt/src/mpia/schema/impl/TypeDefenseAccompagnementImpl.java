...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Type Defense Accompagnement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mpia.schema.impl.TypeDefenseAccompagnementImpl#getPrioriteDefense <em>Priorite Defense</em>}</li>
 *   <li>{@link mpia.schema.impl.TypeDefenseAccompagnementImpl#getAPourLocalisationPCLocalisation <em>APour Localisation PC Localisation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TypeDefenseAccompagnementImpl extends EObjectImpl implements TypeDefenseAccompagnement {
	/**
	 ...
	 * @generated
	 */
	protected TypeDefenseAccompagnementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchemaPackage.eINSTANCE.getTypeDefenseAccompagnement();
	}
	...
	public void setPrioriteDefense(TypeDictionaryDicoPriorite newPrioriteDefense) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__PRIORITE_DEFENSE, oldPrioriteDefense, prioriteDefense, !oldPrioriteDefenseESet));
	}
	...
	public void unsetPrioriteDefense() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__PRIORITE_DEFENSE, oldPrioriteDefense, PRIORITE_DEFENSE_EDEFAULT, oldPrioriteDefenseESet));
	}
	...
	public NotificationChain basicSetAPourLocalisationPCLocalisation(TypeLocalisation newAPourLocalisationPCLocalisation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__APOUR_LOCALISATION_PC_LOCALISATION, oldAPourLocalisationPCLocalisation, newAPourLocalisationPCLocalisation);
	...
	public void setAPourLocalisationPCLocalisation(TypeLocalisation newAPourLocalisationPCLocalisation) {
		if (newAPourLocalisationPCLocalisation != aPourLocalisationPCLocalisation) {
			...
			if (aPourLocalisationPCLocalisation != null)
				msgs = ((InternalEObject)aPourLocalisationPCLocalisation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__APOUR_LOCALISATION_PC_LOCALISATION, null, msgs);
			if (newAPourLocalisationPCLocalisation != null)
				msgs = ((InternalEObject)newAPourLocalisationPCLocalisation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__APOUR_LOCALISATION_PC_LOCALISATION, null, msgs);
			msgs = basicSetAPourLocalisationPCLocalisation(newAPourLocalisationPCLocalisation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__APOUR_LOCALISATION_PC_LOCALISATION, newAPourLocalisationPCLocalisation, newAPourLocalisationPCLocalisation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__APOUR_LOCALISATION_PC_LOCALISATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchemaPackage.TYPE_DEFENSE_ACCOMPAGNEMENT__PRIORITE_DEFENSE:
