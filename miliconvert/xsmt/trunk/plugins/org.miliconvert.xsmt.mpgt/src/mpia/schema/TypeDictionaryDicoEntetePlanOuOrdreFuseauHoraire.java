...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see mpia.schema.SchemaPackage#getTypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire()
 * @model extendedMetaData="name='type_Dictionary_Dico_EntetePlanOuOrdreFuseauHoraire'"
 * @generated
 */
public enum TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int L_VALUE = 11;
	 ...
	 * @ordered
	 */
	public static final int X_VALUE = 14;
	 ...
	 * @ordered
	 */
	public static final int W_VALUE = 15;
	 ...
	 * @ordered
	 */
	public static final int V_VALUE = 16;
	 ...
	 * @ordered
	 */
	public static final int U_VALUE = 17;
	 ...
	 * @ordered
	 */
	public static final int N_VALUE = 24;

	/**
	 * An array of all the '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire[] VALUES_ARRAY =
		new TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire[] {
			Z,
			A,
			B,
			C,
	...
	/**
	 * A public read-only list of all the '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Entete Plan Ou Ordre Fuseau Horaire</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //TypeDictionaryDicoEntetePlanOuOrdreFuseauHoraire
