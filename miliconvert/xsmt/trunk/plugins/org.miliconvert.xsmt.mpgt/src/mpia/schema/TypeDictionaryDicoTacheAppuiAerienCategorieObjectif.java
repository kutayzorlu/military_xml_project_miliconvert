...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see mpia.schema.SchemaPackage#getTypeDictionaryDicoTacheAppuiAerienCategorieObjectif()
 * @model extendedMetaData="name='type_Dictionary_Dico_TacheAppuiAerienCategorieObjectif'"
 * @generated
 */
public enum TypeDictionaryDicoTacheAppuiAerienCategorieObjectif implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int _16_VALUE = 15;
	 ...
	 * @ordered
	 */
	public static final int _17_VALUE = 16;

	/**
	 * An array of all the '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeDictionaryDicoTacheAppuiAerienCategorieObjectif[] VALUES_ARRAY =
		new TypeDictionaryDicoTacheAppuiAerienCategorieObjectif[] {
			_1,
			_2,
			_3,
			_4,
	...
	/**
	 * A public read-only list of all the '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeDictionaryDicoTacheAppuiAerienCategorieObjectif> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoTacheAppuiAerienCategorieObjectif get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoTacheAppuiAerienCategorieObjectif result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoTacheAppuiAerienCategorieObjectif getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoTacheAppuiAerienCategorieObjectif result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Tache Appui Aerien Categorie Objectif</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoTacheAppuiAerienCategorieObjectif get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TypeDictionaryDicoTacheAppuiAerienCategorieObjectif(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //TypeDictionaryDicoTacheAppuiAerienCategorieObjectif
