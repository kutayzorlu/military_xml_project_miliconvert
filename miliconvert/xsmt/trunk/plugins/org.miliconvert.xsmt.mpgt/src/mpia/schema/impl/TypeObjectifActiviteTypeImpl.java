...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Type Objectif Activite Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mpia.schema.impl.TypeObjectifActiviteTypeImpl#getQuantite <em>Quantite</em>}</li>
 *   <li>{@link mpia.schema.impl.TypeObjectifActiviteTypeImpl#getAssocieCommeTypeType <em>Associe Comme Type Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class TypeObjectifActiviteTypeImpl extends EObjectImpl implements TypeObjectifActiviteType {
	/**
	 ...
	 * @generated
	 */
	protected TypeObjectifActiviteTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchemaPackage.eINSTANCE.getTypeObjectifActiviteType();
	}
	...
	public void setQuantite(long newQuantite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__QUANTITE, oldQuantite, quantite, !oldQuantiteESet));
	}
	...
	public void unsetQuantite() {
		...
		quantiteESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__QUANTITE, oldQuantite, QUANTITE_EDEFAULT, oldQuantiteESet));
	}
	...
	public NotificationChain basicSetAssocieCommeTypeType(TypeAssociationEXT newAssocieCommeTypeType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__ASSOCIE_COMME_TYPE_TYPE, oldAssocieCommeTypeType, newAssocieCommeTypeType);
	...
	public void setAssocieCommeTypeType(TypeAssociationEXT newAssocieCommeTypeType) {
		if (newAssocieCommeTypeType != associeCommeTypeType) {
			...
			if (associeCommeTypeType != null)
				msgs = ((InternalEObject)associeCommeTypeType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__ASSOCIE_COMME_TYPE_TYPE, null, msgs);
			if (newAssocieCommeTypeType != null)
				msgs = ((InternalEObject)newAssocieCommeTypeType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__ASSOCIE_COMME_TYPE_TYPE, null, msgs);
			msgs = basicSetAssocieCommeTypeType(newAssocieCommeTypeType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__ASSOCIE_COMME_TYPE_TYPE, newAssocieCommeTypeType, newAssocieCommeTypeType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__ASSOCIE_COMME_TYPE_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchemaPackage.TYPE_OBJECTIF_ACTIVITE_TYPE__QUANTITE:
