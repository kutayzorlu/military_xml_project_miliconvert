...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Dictionary Dico Largeur Fleche</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see mpia.schema.SchemaPackage#getTypeDictionaryDicoLargeurFleche()
 * @model extendedMetaData="name='type_Dictionary_Dico_LargeurFleche'"
 * @generated
 */
public enum TypeDictionaryDicoLargeurFleche implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Type Dictionary Dico Largeur Fleche</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeDictionaryDicoLargeurFleche[] VALUES_ARRAY =
		new TypeDictionaryDicoLargeurFleche[] {
			_1,
			_2,
			_3,
			_4,
	...
	/**
	 * A public read-only list of all the '<em><b>Type Dictionary Dico Largeur Fleche</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeDictionaryDicoLargeurFleche> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Dictionary Dico Largeur Fleche</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoLargeurFleche get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoLargeurFleche result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Largeur Fleche</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoLargeurFleche getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeDictionaryDicoLargeurFleche result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Dictionary Dico Largeur Fleche</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TypeDictionaryDicoLargeurFleche get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TypeDictionaryDicoLargeurFleche(int value, String name, String literal) {
		this.value = value;
		this.name = name;
...
} //TypeDictionaryDicoLargeurFleche
