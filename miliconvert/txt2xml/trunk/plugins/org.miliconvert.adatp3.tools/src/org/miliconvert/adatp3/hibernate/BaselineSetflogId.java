...
/**
 * BaselineSetflogId generated by hbm2java
 */
public class BaselineSetflogId implements java.io.Serializable {
	...
	public BaselineSetflogId() {
	}

	public BaselineSetflogId(Double key, String username, String entry,
			Date logdate) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaselineSetflogId))
			return false;
		BaselineSetflogId castOther = (BaselineSetflogId) other;
