...
/**
 * BaselineClnlcmntId generated by hbm2java
 */
public class BaselineClnlcmntId implements java.io.Serializable {

	private Double key;
	private Date auditdate;
	private String nlcomment;

	public BaselineClnlcmntId() {
	}

	public BaselineClnlcmntId(Double key, Date auditdate, String nlcomment) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaselineClnlcmntId))
			return false;
		BaselineClnlcmntId castOther = (BaselineClnlcmntId) other;
