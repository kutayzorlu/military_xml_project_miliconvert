...
/**
 * BaselineSetnlcmntId generated by hbm2java
 */
public class BaselineSetnlcmntId implements java.io.Serializable {

	private Double key;
	private Date auditdate;
	private String nlcomment;

	public BaselineSetnlcmntId() {
	}

	public BaselineSetnlcmntId(Double key, Date auditdate, String nlcomment) {
		this.key = key;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BaselineSetnlcmntId))
			return false;
		BaselineSetnlcmntId castOther = (BaselineSetnlcmntId) other;
