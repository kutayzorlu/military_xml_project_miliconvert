...
public class CSVBL11FieldMapper implements ICSVFieldMapper {
	...
	private Map<String, Integer> fieldMapping = new HashMap<String, Integer>();

	 {
		...
		fieldMapping.put(ICSVFieldMapper.FFIRN_FUDN, new Integer(4));
		fieldMapping.put(ICSVFieldMapper.STRUCTURE, new Integer(5));
